const mainLayout = (() => {
    const showInquiries = async () => {
        const bootPayMain = document.getElementById("bootpay-main");
        bootPayMain.innerHTML = `
            <div id="header-wrapper">
                <div id="bootpay-header" class="d-flex trial-mode">
                    <div class="flex-grow-1"></div>
                    <div>
                        <div class="header-menu-group d-flex">
                            <a class="boot-link mr-3" href="">
                                <div class="header-menu-btn " data-for="8598bfd3-1b35-4de3-a48f-9d6654dc0268" data-toggle="tooltip" data-custom-class title="공지사항">
                                    <i class="mdi mdi-bullhorn-variant-outline">
                                    </i>
                                </div>
                            </a>
                            <div class="user-menu">
                                <!-- 주석 아래에 show 유무로 메뉴가보임 -->
                                <div id="usermenubtn"class="user-menu-wrapper d-flex align-items-center cursor-pointer"  data-toggle="dropdown">
                                    <div class="user-avatar">T</div>
                                    <div class="user-menu-email">test@gamil.com</div>
                                </div>
                                <div id="usermenu" class="user-menu-content dropdown-menu dropdown-menu-right">
                                    <ul class="menu-body list-unstyled">
                                        <li>
                                            <a class="boot-link d-block text-dark"href="">
                                                <i class="mdi mdi-bell-outline mr-2 mdi-18px"></i>
                                                알림
                                            </a>
                                        </li>
                                        <li>
                                            <a class="d-block text-dark"href="">
                                                <i class="mdi mdi-logout-variant mr-2 mdi-18px"></i>
                                                로그아웃
                                            </a>
                                        </li>
                                    </ul>
            ...
            <div class="page wide-page receipt-index">
            <div class="page-header"> 
                <div class="page-title">문의 내역 조회</div>
                <div class="page-subtitle">회원 문의</div>
            </div>
            <div class="page-body">
                    ...
                    <div class="col col-md-6 col-lg-4 col-xl-3">
                        <div class="pill-box">
                            <div class="pill-title">
                                ...
                                <span>답변완료</span>
                            </div><div class="pill-value">
                                <span class="span-amount">0</span>
                                <span class="amount-unit">건</span>
                            </div></div></div><div class="col col-md-6 col-lg-4 col-xl-3"><div class="pill-box cancel-box">
                            <div class="pill-title">
                            ...
                            <div class="pill-value"><span class="span-amount">0</span><span class="amount-unit">건</span></div>
                        </div>
                    </div>
                </div>
                <div class="page-content">
                    <div class="table-layout white-panel">
                            ...
                            <div class="col-auto">
                                <div class="filter-wrapper filter-status mr-2">
                                    <div class="boot-pop-checkbox">
                                        <button class="boot-pop-checkbox-filter-btn btn btn-outline-filter "id="btn-filter-status" >답변상태 <i class="mdi mdi-menu-down"></i></button>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="boot-check d-flex align-items-center undefined">
                                                                    ...
                                                                    <div class="boot-check-content flex-grow-1">답변완료
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li id="checkboxactive2"class="list-item active">
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="boot-check d-flex align-items-center undefined checked">
                                                                    ...
                                                                    <div class="boot-check-content flex-grow-1">미답변
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="col-auto">
                                <div class="filter-wrapper filter-search">
                                    <div class="input-group">
                                        <input type="text" class="form-control flex-grow-1" placeholder="문의번호/회원">
                        ...
                        <table class="table grey-header-table w-100 text-center receipt-table">
                            <colgroup>
                                <col style="width:15%">
                                <col style="width:15%">
                                <col style="width:17%">
            ...
            <div id ="modal"class="modal fade receipt-modal show"aria-modal="true" role="dialog ">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="modal-title">
                                문의내역
                                <span class="badge-label text-danger font-weight-bold ml-2">미답변</span>
                            </div>
                                ...
                                <div class="tab-view-body">
                                    <div style="display: block;">
                                        <div class="tab-inner tab-detail">
                                            ...
                                            <div class="info-layout payment-info">
                                                <div class="info-title justify-content-between">
                                                    <div class="flex-left d-flex">
                                                    ...
                                                    <div class="table-info row">
                                                        <div class="col-6">
                                                            <div class="row inner-table">
                                                                <div class="col-auto w-120px"style="
                                                                height: 100px;
                                                                display: flex;
                                                                justify-content: center;
                                                                align-items: center;">답변내용
                                                                </div>
                                                                <input type="text" class="col" id=""style="                                                                
                                                                height: 100px;
                                                                display: flex;
                                                                align-items: center;
                                                                border: none;
                        ...
                        <div class="modal-footer">
                            <button class="btn-close btn btn-outline-filter">답변하기</button>
                        </div>
                    </div>
                </div>
            </div>
