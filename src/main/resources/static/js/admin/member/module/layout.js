const memberLayout = (() => {
        ...
        if (members.length === 0) {
            ...
            <tr>
                            <td class="td-name" style="width: 10%;  text-align: center;">
                                <div class="member-name">${member.id}
                            ...
                            <td class="td-action text-center" style="width: 5%;">
                                <div class="action-btn member-detail-btn" data-memberid = ${member.id}>
    ...
    return {showMembers: showMembers, showMemberDetail: showMemberDetail};
})();