...
//        log.info("{}",memberMapper.selectCountAllStatus());
//    }
//    @Test
//    public void testSelectMembers(){
//        Criteria criteria = new Criteria(1,memberMapper.selectCountAllStatus());
//        log.info("{}",memberMapper.selectMembers(criteria));
//    }
//
//    @Test
//    public void testFindCountAll(){
//        log.info("{}",memberDAO.findCountAllStatus());
//    }
//
//    @Test
//    public void testFindAll(){
//        Criteria criteria = new Criteria(1,memberDAO.findCountAllStatus());
//        log.info("{}",memberDAO.findAll(criteria));
//    }
//
//    @Test
//    public void testGetList(){
//        log.info(memberService.getListAllStatus(1).toString());
//    }
//    @Test
